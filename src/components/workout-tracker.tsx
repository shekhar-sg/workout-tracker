...
import TrackerIcon from "../icons/tracker-icon.tsx";
    ...
    return (
        <div
            ...
            <div className={"flex relative items-center justify-center mb-8"}>
                ...
                <h2 className={"m-0 font-semibold text-xl"}>workout tracker</h2>
            </div>
            ...
            <footer
                className={"fixed left-0 bottom-0 w-full h-[76px] flex justify-around gap-16 items-center bg-white"}>
